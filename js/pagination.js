function loophalaman(a) {
    ...
    akhir < maksimal - 1 && (e += "" ? '<span>'+ downPageWord +'</span>'), akhir < maksimal && (e += "page" == jenis ? '<span class="showpageNum"><a href="#" onclick="redirectpage(' + maksimal + ');return false">' + maksimal + '</a></span>' : '<span class="showpageNum"><a href="#" onclick="redirectlabel(' + maksimal + ');return false">' + maksimal + '</a></span><span>'+ downPageWord +'</span>');
